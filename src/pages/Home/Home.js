      ...
      <div className="home">
        ...
        <div className="home__columncontainer">
          <p className="home__name">
            ...
            software development diploma program, where I strengthened my skills
            in Javascript, TypeScript, React, SQL, Node, Express and many
            others. I am most comfortable working with React JS as a front-end
            framework and NodeJS and ExpressJS as back-end frameworks but have a
            breadth of other knowledge and a curious mind!<br></br>
            ...
            parts logical problem-solver and relationship builder. The tasks I
